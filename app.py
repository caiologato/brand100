...
# Nome do banco atualizado para evitar conflitos de versão
DB_NAME = 'cencosud_dooh_v2.db'
...
with tab_plan:
    ...
    if not selected_stores.empty:
        ...
        # Ocultamos a coluna de status no Excel final para manter o formato limpo
