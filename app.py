...
# Banco de dados v4 com os novos campos de CRM
...
def init_db():
    ...
    c = conn.cursor()
    # Tabela com os novos contatos do cliente
...
with tab_plan:
    ...
    # NOVOS CAMPOS: Contato do Anunciante
    ...
    if not selected_stores.empty:
        ...
        with row2_col2:
            # MAPA BLINDADO: Usando o motor nativo do Streamlit
            ...
            if not df_map.empty:
                ...
                st.map(df_map, latitude='Lat', longitude='Lon', size='Alcance Total', color='#13C18E', use_container_width=True)
            else:
        ...
        df_export.to_excel(workbook, index=False, sheet_name='Proposta_DOOH', startrow=12) # Ajustado para startrow 12 para caber o novo cabeçalho
